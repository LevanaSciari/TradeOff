...
public class Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // activity = (TextView)findViewById(R.id.act);
    ...
    void getDataFromDatabase(String email) {
        ...
        databaseReference.child("User").child(email_).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mailTextView.setText(userCurrent.getEmail());
                // activity.setText(userCurrent.getActivity());
...
//    }
    ...
    public void back(View view) {
        Intent act = new Intent(new Intent(Profile.this, Home.class));
        act.putExtra("email", email_);
        startActivity(act);// Write was successful!
    }
}